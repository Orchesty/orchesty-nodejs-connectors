...
export default class ShopifyApplication extends ABasicApplication implements ILimitedApplication {
    ...
    public getDescription(): string {
        return 'Shopify is a subscription-based software that allows anyone to set up an online store and sell their products.  It is a complete commerce platform that lets you start, grow, and manage a business.';
    }
