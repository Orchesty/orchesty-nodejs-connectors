...
export const NAME = 'supply-do-update-product-batch-warehouse';

export default class SupplyDoUpdateProductBatchWarehouse extends AConnector {
    ...
    public async processAction(dto: ProcessDto<IInput>): Promise<ProcessDto<IResponse>> {
        ...
        const req = await this.getApplication().getRequestDto(
            ...
            HttpMethods.PATCH,
            `items/product_batch_warehouse/${data.id}`,
            data,
        );
...
export type IInput = IProductBatch;
