...
export default class MergadoApplication extends AOAuth2Application {
  ...
  public getPublicName = (): string => 'Mergado';

  public getDescription = (): string => 'Mergado description';

  public getAuthUrl = (): string => 'https://app.mergado.com/oauth2/authorize/';

  public getTokenUrl = (): string => 'https://app.mergado.com/oauth2/token/';
