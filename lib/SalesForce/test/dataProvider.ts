...
import SalesForceCreateRecordConnector from '../src/Connector/SalesForceCreateRecordConnector';
import SalesForceUpdateRecordConnector from '../src/Connector/SalesForceUpdateRecordConnector';
import
SalesForceApplication,
{ INSTANCE_NAME, NAME as SALESFORCE_APP }
    from '../src/SalesForceApplication';
