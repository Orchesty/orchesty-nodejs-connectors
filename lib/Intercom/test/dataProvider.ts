...
import IntercomListAllContactsBatch from '../src/Batch/IntercomListAllContactsBatch';
import IntercomCreateContactConnector from '../src/Connector/IntercomCreateContactConnector';
import IntercomApplication, { NAME as INTERCOM_APP } from '../src/IntercomApplication';

export default function init(): void {
    appInstall(INTERCOM_APP, DEFAULT_USER, {
