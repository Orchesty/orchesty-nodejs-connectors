...
import { FlexiBeeCreateSkladovyPohybOutput } from './FlexiBeeCreateSkladovyPohybConnector';

export const FLEXI_BEE_UPDATE_SKLADOVY_POHYB = 'flexi-bee-update-skladovy-pohyb';

export default class FlexiBeeUpdateSkladovyPohybConnector extends AConnector {
    ...
    public getName(): string {
        return FLEXI_BEE_UPDATE_SKLADOVY_POHYB;
    }

    public async processAction(
        dto: ProcessDto<FlexiBeeUpdateSkladovyPohybInput>,
...
export interface FlexiBeeUpdateSkladovyPohybInput {
    id: string;
    kod: string;
    typPohybuK: string;
    typDokl: string;
...
export type FlexiBeeUpdateSkladovyPohybOutput = ResponseResult[];
