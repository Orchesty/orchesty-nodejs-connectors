...
export const NAME = `${FLEXI_BEE_APPLICATION}-create-zavazek-connector`;

export default class FlexiBeeCreateZavazekConnector extends AConnector {
    ...
    public async processAction(dto: ProcessDto): Promise<ProcessDto<IOutput[]>> {
        ...
        const request = await application.getRequestDto(
            ...
            applicationInstall,
            HttpMethods.POST,
            application.getUrl(applicationInstall, 'zavazek'),
            dto.getJsonData(),
        );
