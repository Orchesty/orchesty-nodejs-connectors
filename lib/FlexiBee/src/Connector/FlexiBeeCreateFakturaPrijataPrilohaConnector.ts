...
export const NAME = `${FLEXI_BEE_APPLICATION}-create-faktura-prijata-priloha-connector`;

export default class FlexiBeeCreateFakturaPrijataPrilohaConnector extends AConnector {
