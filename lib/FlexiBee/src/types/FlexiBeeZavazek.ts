/* eslint-disable */
export interface FlexiBeeZavazek {
    'external-ids'?: string[];
    'id': string;
    'lastUpdate': string;
    'updatedBy': string;
    ...
    'region': string;
    'banSpojDod': string;
    'banSpojDod@showAs': string;
    'banSpojDod@if-not-found': string;
    'banSpojDod@ref': string;
    'bankovniUcet': string;
    'bankovniUcet@ref': string;
    'bankovniUcet@showAs': string;
    'typDoklBan': string;
    'typDoklBan@ref': string;
    'typDoklBan@showAs': string;
    'typUcOp': string;
    'typUcOp@ref': string;
    ...
    'dphZaklUcet': string;
    'dphZaklUcet@ref': string;
    'dphZaklUcet@showAs': string;
    'dphSnizUcet': string;
    'dphSnizUcet@ref': string;
    'dphSnizUcet@showAs': string;
    'dphSniz2Ucet': string;
    'dphSniz2Ucet@ref': string;
    'dphSniz2Ucet@showAs': string;
    'smerKod': string;
    'smerKod@ref': string;
    'smerKod@showAs': string;
    'statDph': string;
    'statDph@ref': string;
    ...
    'statUrc': string;
    'statPuvod': string;
    'statPuvod@ref': string;
    'statPuvod@showAs': string;
    'dodPodm': string;
    'obchTrans': string;
    'druhDopr': string;
    'zvlPoh': string;
    ...
    'sazbaDphSniz2@ref': string;
    'sazbaDphSniz2@showAs': string;
    'sazbaDphZakl': string;
    ...
    'clenKonVykDph@ref': string;
    'clenKonVykDph@showAs': string;
    'datUp1': string;
    'datUp2': string;
    'datSmir': string;
    'datPenale': string;
