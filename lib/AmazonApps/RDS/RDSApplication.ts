...
export default class RDSApplication extends AAwsApplication {
    ...
    public getDescription(): string {
        return 'Amazon Relational Database Service (Amazon RDS) is a web service that makes it easier to set up, operate, and scale a relational database in the cloud. ';
    }
