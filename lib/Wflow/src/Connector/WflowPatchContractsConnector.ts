...
export const NAME = `${WFLOW_APP_NAME}-patch-contracts-connector`;

export default class WflowPatchContractsConnector extends AConnector {
    ...
    public async processAction(dto: ProcessDto<IInput | IInput[]>): Promise<ProcessDto<IOutput>> {
        ...
        const requestDto = application.getRequestDto(
            ...
            applicationInstall,
            HttpMethods.PATCH,
            `/${application.getOrganization(applicationInstall)}/registers/contracts`,
