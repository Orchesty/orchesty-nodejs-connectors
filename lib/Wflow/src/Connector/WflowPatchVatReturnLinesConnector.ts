...
export const NAME = `${WFLOW_APP_NAME}-patch-vat-return-lines-connector`;

export default class WflowPatchVatReturnLinesConnector extends AConnector {
    ...
    public async processAction(dto: ProcessDto<IInput | IInput[]>): Promise<ProcessDto<IOutput>> {
        ...
        const requestDto = application.getRequestDto(
            ...
            applicationInstall,
            HttpMethods.PATCH,
            `/${application.getOrganization(applicationInstall)}/registers/vatreturnlines`,
