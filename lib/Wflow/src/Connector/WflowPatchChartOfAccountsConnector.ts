...
export const NAME = `${WFLOW_APP_NAME}-patch-chart-of-accounts-connector`;

export default class WflowPatchChartOfAccountsConnector extends AConnector {
    ...
    public async processAction(dto: ProcessDto<IInput | IInput[]>): Promise<ProcessDto<IOutput>> {
        ...
        const requestDto = application.getRequestDto(
            ...
            applicationInstall,
            HttpMethods.PATCH,
            `/${application.getOrganization(applicationInstall)}/registers/chartofaccounts`,
