...
[![npm](https://img.shields.io/npm/v/@orchesty/connector-google-big-query?color=15ba68)](https://www.npmjs.com/package/@orchesty/connector-google-big-query)
[![License](https://img.shields.io/badge/license-Apache--2.0-15ba68)](https://github.com/Orchesty/orchesty-nodejs-connectors/blob/master/LICENSE)

An [Orchesty](https://orchesty.io) connector for Google BigQuery, a fully managed, serverless data warehouse that enables scalable analysis over petabytes of data.
...
6. Enable the **BigQuery API** under **APIs & Services → Library**.
7. In Orchesty, open the Google BigQuery application settings, enter the credentials, and complete the OAuth authorization flow.

### API Documentation

Google BigQuery REST API: [https://cloud.google.com/bigquery/docs/reference/rest](https://cloud.google.com/bigquery/docs/reference/rest)
...
# or
pnpm add @orchesty/connector-google-big-query @orchesty/nodejs-sdk
```
...
container.setNode(new BigQueryListAllDatasets(), app);
```
